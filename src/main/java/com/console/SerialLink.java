    ...
    private static void changeDmxSerialInput(String s) {
        ...
        if (Main.getSelectedLampe() != lampeAlt) {
            ...
            try {
                ...
                posAlt[14] = (byte) LampActions.getMatrix();
        ...
        //System.out.println(result[14] + "  " + LampActions.getMatrix());
